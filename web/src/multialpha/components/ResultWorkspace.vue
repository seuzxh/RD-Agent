<template>
  <section class="result-workspace">
    ...
    <div class="result-body">
      ...
      <div v-else-if="tab==='chart'" class="chart-wrap"><iframe v-if="stableChartHtml" class="center-chart-frame" :srcdoc="stableChartHtml" sandbox="allow-scripts"/><div v-else class="empty-result">当前轮次暂无收益曲线</div></div>
