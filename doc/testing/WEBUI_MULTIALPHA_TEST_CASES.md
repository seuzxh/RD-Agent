# multialpha webUI 全面测试用例

> 范围：multialpha 子应用全部功能（任务创建 / 因子挖掘全流程 / 用户交互 / 股池预测 / 日志 / 健康检查 / 列表管理）
...
| 编号 | 用例 | 前置条件 | 操作步骤 | 预期结果 | 优先级 |
|---|---|---|---|---|---|
| TC-DO-01 | 品牌一致性 | 任意页 | 检查 logo/标题/α 符号/V 形元素 | 国新证券 logo、MultiAlpha 品牌、α/V 视觉语言一致 | P2 |
...
**更新来源**：multialpha webUI 全功能特性梳理后整理的综合测试用例
